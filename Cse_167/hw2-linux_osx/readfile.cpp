  ...
  if (in.is_open()) {
      ...
      if ((str.find_first_not_of(" \t\r\n") != string::npos) && (str[0] != '#')) {
        ...
        if (cmd == "light") {
          if (numused == numLights) { // No more Lights 
            ...
            if (validinput) {
              ...
              GLfloat lightpos_temp[4] = {values[0], values[1], values[2], values[3]};
              matransform(transfstack, lightpos_temp);
              
              // Store transformed position and color
              for (int j = 0; j < 4; j++) {
                lightposn[4 * numused + j] = lightpos_temp[j];
                lightcolor[4 * numused + j] = values[4 + j];
              }
        ...
        // Note that no transforms/stacks are applied to the colors. 
          ...
          if (validinput) {
            ...
            // Update eyeinit and upinit for reset functionality
            eyeinit = eye;
            upinit = up;
        ...
        // Also look at demo.txt to get a sense of why things are done this way.
          ...
          if (numobjects == maxobjects) { // No more objects 
            ...
            cout << "Object " << numobjects << ": type=" << cmd 
                << " size=" << obj->size << endl;
            cout << "Transform matrix:" << endl;
            mat4 t = obj->transform;
            cout << t[0][0] << " " << t[1][0] << " " << t[2][0] << " " << t[3][0] << endl;
            cout << t[0][1] << " " << t[1][1] << " " << t[2][1] << " " << t[3][1] << endl;
            cout << t[0][2] << " " << t[1][2] << " " << t[2][2] << " " << t[3][2] << endl;
            cout << t[0][3] << " " << t[1][3] << " " << t[2][3] << " " << t[3][3] << endl;
    ...
    rightmultiply(S, transfstack);
          ...
          if (validinput) {
            ...
            mat3 R3 = Transform::rotate(angle, axis);
